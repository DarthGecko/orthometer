...
class BioMart(REST):
    ...
    **protein**, we need to add this dataset to the query::
    ...
    def __init__(self, host=None, verbose=False, cache=False, format = "FASTA"):
        """.. rubric:: Constructor
        ...
        self._biomartQuery = BioMartQuery(format)
...
class BioMartQuery(object):
    def __init__(self, formatter="FASTA", version="1.0", virtualScheme="zome_mart"):
